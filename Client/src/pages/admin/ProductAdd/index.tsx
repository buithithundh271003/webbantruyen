...
import { getAllChuyenMuc } from '../../../redux/Reducer/ChuyenMuc';
...
const productAdd = () => {
    ...
    console.log("chuyemmuc", chuyenmucs);
    const optionChuyenmuc=  chuyenmucs
    ?.filter((chm: IChuyenMuc) => chm.name !== "Uncategorized") // Loại bỏ danh mục "Uncategorized"
    .map((chm: ICategory) => ({
        label: `${chm.name}`,
        value: `${chm._id!}`,
    }));
    console.log("test",optionChuyenmuc);
        ...
        {isLoading ? (
            ...
            <div>
                ...
                >
                    ...
                    <Form.Item name="chuyenMucId" label="ChuyenMuc" rules={[{ required: true, message: 'Please input your Category!' }]}>
                        <Select
                            placeholder="Select a category"
                            allowClear
                            options={optionChuyenmuc}
                        ></Select>
                    </Form.Item>
